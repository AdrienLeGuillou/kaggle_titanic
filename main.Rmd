...
With the titles maybe I can do a better job at infering the ages. 

I will try to examine the relations between `category`, `ticket_class` and 
`age`.

```{r age-missing}
# see if the data is missing at random or not
# inspect mice package and rpart
```
